...
abstract class Product implements ActiveRecordInterface 
{
    ...
    public function setUrl($v)
    {
        ...
        if ($this->url !== $v) {
            $this->url = $v;
            $this->modifiedColumns[ProductTableMap::COL_URL] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ProductTableMap::translateFieldName('Url', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ProductTableMap::COL_URL)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProductTableMap::COL_URL)) {
            $criteria->add(ProductTableMap::COL_URL, $this->url);
        }
    ...
    public function setProductImages(Collection $productImages, ConnectionInterface $con = null)
    {
        ...
        $this->productImagesScheduledForDeletion = clone $productImagesToDelete;
     ...
     * @return ObjectCollection|ChildProductImage[] List of ChildProductImage objects
     */
    public function getProductImagesJoinImage(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildProductImageQuery::create(null, $criteria);
