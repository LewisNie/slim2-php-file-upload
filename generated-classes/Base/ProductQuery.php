 ...
 * @method     ChildProductQuery orderByUrl($order = Criteria::ASC) Order by the url column
 *
 * @method     ChildProductQuery groupById() Group by the id column
 * @method     ChildProductQuery groupByName() Group by the name column
 * @method     ChildProductQuery groupByUrl() Group by the url column
 *
 ...
 * @method     ChildProduct findOneByUrl(string $url) Return the first ChildProduct filtered by the url column *
 ...
 * @method     ChildProduct requireOneByUrl(string $url) Return the first ChildProduct filtered by the url column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildProduct[]|ObjectCollection findByUrl(string $url) Return ChildProduct objects filtered by the url column
...
abstract class ProductQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'test2', $modelName = '\\Product', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, name, url FROM product WHERE id = :p0';
        try {
    ...
    public function filterByUrl($url = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ProductTableMap::COL_URL, $url, $comparison);
    }
