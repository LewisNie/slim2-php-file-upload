...
abstract class Image implements ActiveRecordInterface 
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ImageTableMap::translateFieldName('Url', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function setProductImages(Collection $productImages, ConnectionInterface $con = null)
    {
        ...
        foreach ($productImagesToDelete as $productImageRemoved) {
            $productImageRemoved->setImage(null);
        }
     ...
     * @return ObjectCollection|ChildProductImage[] List of ChildProductImage objects
     */
    public function getProductImagesJoinProduct(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildProductImageQuery::create(null, $criteria);
