...
class ImageTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Url', ),
        self::TYPE_CAMELNAME     => array('id', 'url', ),
        self::TYPE_COLNAME       => array(ImageTableMap::COL_ID, ImageTableMap::COL_URL, ),
        self::TYPE_FIELDNAME     => array('id', 'url', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Url' => 1, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'url' => 1, ),
        self::TYPE_COLNAME       => array(ImageTableMap::COL_ID => 0, ImageTableMap::COL_URL => 1, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'url' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
