...
class ProductTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Url', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'url', ),
        self::TYPE_COLNAME       => array(ProductTableMap::COL_ID, ProductTableMap::COL_NAME, ProductTableMap::COL_URL, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'url', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Url' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'url' => 2, ),
        self::TYPE_COLNAME       => array(ProductTableMap::COL_ID => 0, ProductTableMap::COL_NAME => 1, ProductTableMap::COL_URL => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'url' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ProductTableMap::COL_URL);
        } else {
